...
@export var sprite_texture: Texture2D = preload("res://src/shared/assets/sprites/player_spritesheet.png")
...
## Diccionario de preguntas de respaldo (clave: pregunta, valor: respuesta) en caso de que falle la IA
@export var fallback_qa: Dictionary = {}
...
func _on_interact_pressed() -> void:
	...
	if is_ai:
		AiDialogBox.show_dialog(npc_name, lines, ai_system_prompt, fallback_qa)
	else:

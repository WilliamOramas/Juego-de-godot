...
const TRANSITION_SCENE: String = "res://src/features/menu/screens/main_menu.tscn"
...
func _ready() -> void:
	...
	var hint_font := load("res://src/shared/fonts/coolvetica/Coolvetica Rg.otf") as Font
	if hint_font:

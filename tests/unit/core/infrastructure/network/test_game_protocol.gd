...
const GameProtocolScript = preload("res://src/core/infrastructure/network/game_protocol.gd")
const MiniFaintingFirstAidScript = preload("res://src/features/minigames/mini_fainting_first_aid.gd")
const MiniCprScript = preload("res://src/features/minigames/mini_cpr.gd")

...
- Contextualiza para Venezuela (ej. el número único de emergencias es 911, clima tropical caribeño).
- Enfócate en accidentes universitarios y lugares cerrados (caídas en escaleras, laboratorios, pasillos).
...
const FALLBACK_QUESTIONS: Array[Dictionary] = [
	...
	{
		"q": "¿Cuál es el número único de emergencias en Venezuela?",
		"ops": ["171", "911", "112", "0800-AYUDA"],
		"ans": 1,
	},
	{
	...
	{
		"q": "Caída grave por las escaleras de la universidad.",
		"ops": ["Levantar rápido", "No mover al paciente y llamar al 911", "Dar agua fría", "Sentarlo de golpe"],
		"ans": 1,
	},
	{
	...
	{
		"q": "Quemadura térmica en el laboratorio de química.",
		"ops": ["Aplicar hielo directo", "Agua fría abundante por 10 min", "Poner crema hidratante", "Cubrir con vendaje seco sin lavar"],
		"ans": 1,
	},
	{

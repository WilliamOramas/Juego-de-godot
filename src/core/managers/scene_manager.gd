...
func _ready() -> void:
	...
	var transition_scene: PackedScene = load("res://src/shared/ui/components/scene_transition.tscn")
	...
	var loading_scene = load("res://src/shared/ui/screens/loading_screen.tscn") as PackedScene
	if loading_scene:
	...
	var blur_shader: Shader = load("res://src/shared/assets/shaders/time_blur.gdshader")
	if blur_shader:

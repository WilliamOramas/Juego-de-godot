...
const TriviaQuestionGeneratorScript = preload("res://src/features/minigames/components/trivia_question_generator.gd")
...
static func _test_pick_question_by_difficulty(runner) -> void:
	...
	runner.assert_eq(only_hard.get("q", ""), "Difícil B")

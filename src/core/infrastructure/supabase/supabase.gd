...
func _load_config() -> void:
	...
	if err == OK:
		...
		push_warning("Supabase: No se encontró config.cfg. Por favor crea el archivo con la url y key de tu proyecto.")
...
func login(email: String, password: String) -> void:
	...
	if supabase_url == "" or supabase_key == "":
		auth_completed.emit(false, "Faltan las credenciales de Supabase en config.cfg")
		return

...
const KEYCAP_NORMAL = preload("res://src/shared/assets/sprites/keycap_q.svg")
const KEYCAP_PRESSED = preload("res://src/shared/assets/sprites/keycap_q_pressed.svg")
...
func setup(minigame: MiniFaintingFirstAid, animation_controller: FaintingAnimationController) -> void:
	...
	progress_bar.offset_left = 120
	progress_bar.offset_top = 258
	progress_bar.offset_right = 600
	...
	for i in range(3):
		...
		heart_rect.texture = load("res://src/shared/assets/sprites/heart_pixel.svg")
	...
	touch_button.offset_top = 480
	touch_button.offset_right = 192
	touch_button.offset_bottom = 550
	...
	touch_button.add_theme_font_size_override("font_size", 28)
	...
	touch_dial_container.offset_top = 470
	touch_dial_container.offset_right = 272
	touch_dial_container.offset_bottom = 550
	...
	for i in range(3):
		...
		dial_btn.add_theme_font_size_override("font_size", 30)
